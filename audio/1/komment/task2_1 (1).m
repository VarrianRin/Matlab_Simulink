...
% 1) Если разложить клиппированную синусоиду по базису синусных функций, то
% мы получим множество составляющих. Почему в данном случае в спектре
% появилась только одна дополнительная составляющая? Разве из суммы двух
% синусоид складывается клиппированная синусоида?
